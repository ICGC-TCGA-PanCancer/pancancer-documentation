...
foreach my $a ("defiles.txt","pbcadefiles.txt","malydefiles.txt","eopcdefiles.txt","brcaukfiles.txt","cmdiukfiles.txt","bocaukfiles.txt","pradukfiles.txt","esadukfiles.txt","brcaeufiles.txt","pacacafiles.txt","esfiles.txt","sgfiles.txt","jpfiles.txt","krfiles.txt","orcainfiles.txt","pacaaufiles.txt","paenaufiles.txt","ovaufiles.txt","gacacnfiles.txt"){
  $count1 = 0;
  $count2 = 0;
