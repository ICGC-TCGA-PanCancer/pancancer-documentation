...
foreach my $a ("defiles.txt","pbcadefiles.txt","malydefiles.txt","eopcdefiles.txt","brcaukfiles.txt","cmdiukfiles.txt","bocaukfiles.txt","pradukfiles.txt","esadukfiles.txt","brcaeufiles.txt","cafiles.txt","esfiles.txt","sgfiles.txt","jpfiles.txt","krfiles.txt","lirijpfiles.txt","krfiles.txt"){
  $count1 = 0;
  $count2 = 0;
